...
public class VocabHunterGuiExecutable extends Application {
    ...
    public void start(final Stage stage) {
        ...
        try {
            ...
            GuiFactory factory = new GuiFactoryImpl(fileDialogueFactory, stage);
    ...
    public static void main(final String... args) {
        runApp(args, a -> launch(a));
    }

    public static void runApp(final String[] args, final Consumer<String[]> launcher) {
        logStartup();
        try {
            logSystemDetails();
