...
import io.github.vocabhunter.gui.services.EnvironmentManagerImpl;
import io.github.vocabhunter.gui.services.PlacementManagerImpl;
import io.github.vocabhunter.gui.services.SessionFileService;
import io.github.vocabhunter.gui.services.WebPageToolImpl;
...
public final class GuiContainerBuilder {
    ...
    public static MutablePicoContainer createGuiContainer(final String... args) {
        ...
        pico.addComponent(GuiTaskHandlerImpl.class);
