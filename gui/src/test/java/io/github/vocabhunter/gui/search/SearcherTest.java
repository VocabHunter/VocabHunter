...
public class SearcherTest {
    ...
    public void testMatchFirstWord() {
        ...
        validateMatch(result, "1 of 3 matches", null, WORD_AB);
    }
    ...
    public void testMatchSecondWord() {
        ...
        validateMatch(result, "2 of 3 matches", WORD_AA, WORD_AC);
    }
    ...
    public void testMatchThirdWord() {
        ...
        validateMatch(result, "3 of 3 matches", WORD_AB, null);
    }
    ...
    public void testBeforeFirstWord() {
        ...
        validateMatch(result, "2 matches", null, WORD_AB);
    }
    ...
    public void testBetweenMatches() {
        ...
        validateMatch(result, "2 matches", WORD_AB, WORD_BC);
    }
    ...
    public void testAfterMatches() {
        ...
        validateMatch(result, "3 matches", WORD_AC, null);
    }

    private void validateEmptySearch(final SearchResult<TestSequencedWord> result) {
        validate(result, "", null, null, false);
    }

    private void validateNoMatch(final SearchResult<TestSequencedWord> result) {
        validate(result, "No matches", null, null, true);
    }

    private void validateMatch(final SearchResult<TestSequencedWord> result, final String matchDescription, final TestSequencedWord previousMatch, final TestSequencedWord nextMatch) {
        validate(result, matchDescription, previousMatch, nextMatch, false);
    }

    private void validate(
        final SearchResult<TestSequencedWord> result, final String matchDescription,
        final TestSequencedWord previousMatch, final TestSequencedWord nextMatch, final boolean isSearchFail) {
        SearchResult<TestSequencedWord> expected = new SearchResult<>(matchDescription, previousMatch, nextMatch, isSearchFail);
